...
INSERT INTO Cats (name, gender, nickname, function, chief, in_herd_since, mice_ration, mice_extra, band_no) VALUES ('LUCEK','M','ZERO','CAT','HEN','2010-03-01',43,NULL,3);
...
INSERT INTO Incidents(nickname, enemy_name, incident_date, incident_desc) VALUES ('MISS','WILD BILL','2008-12-12','HE BITCHED');
INSERT INTO Incidents(nickname, enemy_name, incident_date, incident_desc) VALUES ('MISS','KAZIO','2009-01-07','HE CAUGHT THE TAIL AND MADE A WIND');
INSERT INTO Incidents(nickname, enemy_name, incident_date, incident_desc) VALUES ('LADY','KAZIO','2009-02-07','HE WANTED TO SKIN OFF');
INSERT INTO Incidents(nickname, enemy_name, incident_date, incident_desc) VALUES ('MAN','REKS','2009-04-14','HE BARKED EXTREMELY RUDELY');
INSERT INTO Incidents(nickname, enemy_name, incident_date, incident_desc) VALUES ('BALD','BETHOVEN','2009-05-11','HE DID NOT SHARE THE PORRIDGE');
INSERT INTO Incidents(nickname, enemy_name, incident_date, incident_desc) VALUES ('TUBE','WILD BILL','2009-09-03','HE TOOK THE TAIL');
INSERT INTO Incidents(nickname, enemy_name, incident_date, incident_desc) VALUES ('CAKE','BASIL','2010-07-12','HE PREVENTED THE CHICKEN FROM BEING HUNTED');
